...
// 定义CMF根目录,可更改此目录
define('CMF_ROOT', __DIR__ . '/../'); //F:\phpStudy\WWW\shouhuan\public/../
// define('CMF_ROOT', dirname(__DIR__) . '/');  // F:\phpStudy\WWW\shouhuan/
...
echo CMF_ROOT. 'simplewind/thinkphp/base.php';
exit();
